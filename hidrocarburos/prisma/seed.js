...
async function main() {
  ...
  await prisma.sistema.createMany({
    data: [
      { nombreSistema: 'Bombeo Mecánico', sigla: 'BM' },
      { nombreSistema: 'Bombeo Hidráulico', sigla: 'BH' },
      { nombreSistema: 'Bombeo Sumergible', sigla: 'BES' },
      { nombreSistema: 'Gas Lift', sigla: 'GL' },
      { nombreSistema: 'Cavidad Progresiva', sigla: 'BCP' },
      { nombreSistema: 'Plunger Lift', sigla: 'PL' },
      { nombreSistema: 'Jet Pump', sigla: 'JP' },
      { nombreSistema: 'Otros Tipos de Extracción', sigla: 'OTE' },
      { nombreSistema: 'Surgencia Natural', sigla: 'SN' },
      { nombreSistema: 'Pistoneo', sigla: 'PIST' },
    ]

  });

  // 9. Crear Pozo Sistema
  await prisma.pozoSistema.createMany({
    data: [
      { cantidad: 1240, mes: 8, anio: 2025, observaciones: null, sistemaId: 1 },
      { cantidad: 1340, mes: 8, anio: 2025, observaciones: null, sistemaId: 2 },
      { cantidad: 1440, mes: 8, anio: 2025, observaciones: null, sistemaId: 3 },
      { cantidad: 1540, mes: 8, anio: 2025, observaciones: null, sistemaId: 4 },
      { cantidad: 1640, mes: 8, anio: 2025, observaciones: null, sistemaId: 5 },
      { cantidad: 1740, mes: 8, anio: 2025, observaciones: null, sistemaId: 6 },
      { cantidad: 1840, mes: 8, anio: 2025, observaciones: null, sistemaId: 7 },
      { cantidad: 1940, mes: 8, anio: 2025, observaciones: null, sistemaId: 8 },
      { cantidad: 2040, mes: 8, anio: 2025, observaciones: null, sistemaId: 9 },
      { cantidad: 2140, mes: 8, anio: 2025, observaciones: null, sistemaId: 10 },
